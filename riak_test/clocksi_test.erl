...
clocksi_test1(Nodes) ->
    ...
    Result0=rpc:call(FirstNode, antidote, clocksi_execute_g_tx,
                    [[[]]]),
    ?assertMatch({ok, _}, Result0),
    Result1=rpc:call(FirstNode, antidote, clocksi_execute_g_tx,
                    [[[]]]),
    ?assertMatch({ok, _}, Result1),

    % A simple read returns empty
    Result11=rpc:call(FirstNode, antidote, clocksi_execute_g_tx,
                    [
                     [[{read, key1, Type}]]]),
    ...
    %% Read what you wrote
    Result2=rpc:call(FirstNode, antidote, clocksi_execute_g_tx,
                    [
                      [[{read, key1, Type},
    ...
    Result3=rpc:call(FirstNode, antidote, clocksi_execute_g_tx,
                    [
                     [[{read, key1, Type},
                      {read, key2, Type}]]]),
    ...
    Result5=rpc:call(FirstNode, antidote, clocksi_execute_g_tx,
                    [
                     [[{update, key1, Type, {increment, a}},
                      {update, key1, Type, {increment, a}}]]]),
    ?assertMatch({ok,_}, Result5),

    Result6=rpc:call(FirstNode, antidote, clocksi_execute_g_tx,
                    [
                     [[{read, key1, Type}]]]),
