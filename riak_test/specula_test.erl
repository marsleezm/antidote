...
%%
%% -------------------------------------------------------------------
%%%%%% Specula length has to be 5 here!!!!!! %%%%%%%%


-module(specula_test).

-export([confirm/0, spawn_receive/5, replicates/1, specula_test2/1, specula_test3/1]).
...
specula_test1(Nodes) ->
    ...
    %% Replica of partition 2 and 4 are blocked (but replicated...)
